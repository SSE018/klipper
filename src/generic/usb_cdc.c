...
// below, alter the board Makefile to include the USB object files
// during a serial UART build, compile the code using serial UART, add
// output() calls to the USB code as needed, deploy the new binary,
// and then connect via console.py using UART to see those output()
// messages.
